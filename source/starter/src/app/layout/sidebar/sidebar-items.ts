...
export const ROUTES: RouteInfo[] = [
  ...
  // Leaves Module — Admin & HR see all leaves with approve/reject ability
  {
    path: "",
    title: "Leaves",
    iconType: "feather",
  ...
  // Leaves Module — BA, BDE, Employee see ONLY their own leaves (same route, component filters)
  {
    path: "/admin/leaves/leave-requests",
    title: "My Leaves",
    iconType: "feather",
