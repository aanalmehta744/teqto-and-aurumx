...
export const ROUTES: RouteInfo[] = [
  ...
  //     },
  //     {
  //       path: '/employee/jobs/interview-schedule',
  ...
  // },
  {
    ...
    submenu: [
      ...
      // {
      //   path: '/client/clients/edit-client',
      //   title: 'MENUITEMS.CLIENTS.LIST.EDIT-CLIENT',
      //   iconType: '',
      //   icon: '',
      //   class: 'ml-menu',
