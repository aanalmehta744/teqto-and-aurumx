...
export class CandidatesComponent
  ...
  viewDetails(row: Candidates) {
    this.router.navigate(['employee/jobs/candidateDetails', row.id]);
  }
  ...
  public loadData() {
    this.exampleDatabase = this.candidatesService;

    this.subs.sink = this.exampleDatabase.getAllCandidates().subscribe({
      next: (data) => {
        this.exampleDatabase!.dataChange.next(data); // non-null assertion
      },
      error: (error) => {
    ...
    return merge(...displayDataChanges).pipe(
      map(() => {
        ...
        this.filteredData = this.exampleDatabase.data
          .slice()
          .filter((candidates: Candidates | null | undefined) => {
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'time':
          ...
          break;
        case 'name':
          [propertyA, propertyB] = [a.full_name, b.full_name];
          break;
      }
