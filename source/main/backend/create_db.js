...
async function setup() {
    ...
    const tables = [
        ...
        'CREATE TABLE IF NOT EXISTS salary_payslip (id INT AUTO_INCREMENT PRIMARY KEY, employee_id INT, month INT, year INT, working_days DECIMAL(5, 2), paid_leave_days DECIMAL(5, 2), unpaid_leave_days DECIMAL(5, 2), net_salary DECIMAL(10, 2), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)',
