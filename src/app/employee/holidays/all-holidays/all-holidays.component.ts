...
export class AllHolidayComponent
  ...
  public loadData() {
    this.exampleDatabase = this.holidayService;
        ...
        this.filteredData = this.exampleDatabase.data
          ...
          .filter((holiday: AllHoliday) => {
            ...
            if (holiday.date) {
              ...
              // Push various formats for better matching
              dateFormats.push(
                formatDate(dateObj, 'yyyy-MM-dd', 'en'),
                formatDate(dateObj, 'dd-MM-yyyy', 'en'),
                formatDate(dateObj, 'dd MMM yyyy', 'en'),
                formatDate(dateObj, 'MMM d, yyyy', 'en')
              );
            }
